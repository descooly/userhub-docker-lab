# 🚀 UserHub — Лабораторная работа по Docker

**Дисциплина:** Технологии программирования  
**Курс:** 3 | ИТ  
**Тема:** Основы работы с Docker и Docker Compose  
**Дата выполнения:** 25 марта 2026 г.

## Цель работы

Изучить контейнеризацию приложений с помощью Docker, научиться создавать многоконтейнерные приложения с использованием Docker Compose, работать с volumes, networks, healthchecks и .env-файлами.
